...
//Write Test
test('Failed Traces In Playwright',async ({ page }) => {
    // Goto URL
await page.goto('https://www.google.com/search?q=tester+talk');
await page.setViewportSize({width:1386,height:788});// maximize the the webpage.
// Assert URL
...
await expect(page).toHaveTitle('tester talk12 - Google Search');
